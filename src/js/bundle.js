...
function(e,t,n){var r=n(/*! react */1);e.exports=r.createClass({displayName:"exports",render:function(){return r.createElement("div",{className:"menu-button pointer",title:"Menu",onClick:this.props.callback},String.fromCharCode(9776))}})},/*!*************************************!*\
  ...
  \*************************************/
function(e,t,n){var r=n(/*! leaflet */13),a={};a.init=function(){var e=r.map("map",{zoomControl:!1,detectRetina:!0}).setView([37.78,-92.85],4);window.map=e,r.control.zoom({position:"topright"}).addTo(e);var t='Map data © <a href="http://openstreetmap.org">OpenStreetMap</a> contributors',n=new r.TileLayer("http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:t});e.addLayer(n)},e.exports=a},/*!**************************!*\
  !*** ./src/css/app.styl ***!
  \**************************/
